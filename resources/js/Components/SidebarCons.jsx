            ...
            <div className="fixed flex flex-col top-0 left-0 w-64 bg-green-200 h-full border-r">
                ...
                <div className="overflow-y-auto overflow-x-hidden flex-grow">
                    <ul className="flex flex-col py-4 space-y-1">
                        ...
                        <Link href={route('searchview')} className="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-500 pr-6">
                            <span className="inline-flex justify-center items-center ml-4">
                                <ListTodoIcon size={15} />
                            </span>
                            <span className="ml-2 text-sm tracking-wide truncate">
                                Vos Cr&eacute;ations
                            </span>
                        </Link>
                        <Link href={route('membres')} className="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-500 pr-6">
                            <span className="inline-flex justify-center items-center ml-4">
                                <ListTodoIcon size={15} />
                            </span>
                            <span className="ml-2 text-sm tracking-wide truncate">
                        ...
                        { user.roles !== 'Super' ?
                            ...
                            <Link href={route('archivbygroup')} className="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-500 pr-6">
                                ...
                                <span className="ml-2 text-sm tracking-wide truncate">
                                    Archives par groupe d'acc&egrave;s
                                </span>
                            </Link>
                        }
                        ...
                        <Link href={route('dossierrh.view')} className="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-500 pr-6">
                            <span className="inline-flex justify-center items-center ml-4">
                                <ListChecksIcon size={15} />
                            </span>
                            <span className="ml-2 text-sm tracking-wide truncate">
